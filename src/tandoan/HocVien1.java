...
public class HocVien1 {
	...
	public HocVien1(int maHV, String tenHv, String lop, float diemJava, float diemOracle, float diemProject) {
		super();
		this.MaHV = maHV;
		this.TenHv = tenHv;
		this.Lop = lop;
	...
	public String toString() {
		return "Mã Học Viên:" + this.MaHV + "Học viên tên: " + this.TenHv + "- Lớp :" + this.Lop + "Điểm Java:"
				+ this.DiemJava + "Điểm Oracle: " + this.DiemOracle + "Điểm Project: " + this.DiemProject;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Diem trung binh 3 mon cua hoc vien 3la :" + c);
